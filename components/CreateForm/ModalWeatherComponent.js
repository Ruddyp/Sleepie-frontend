import { StyleSheet, View, Modal, Dimensions, TouchableOpacity, Text, Pressable, } from "react-native";
import { useDispatch, useSelector } from "react-redux";
import { updateModalParamStateWeather } from "../../reducers/modalparam";
...
export default function ModalWeatherComponent() {
    ...
    return (
        <Modal
            animationType="slide"
            transparent={true}
            visible={modalparam.modalStateWeather}
            onRequestClose={() => dispatch(updateModalParamStateWeather(false))}
        >
            <LinearGradient
